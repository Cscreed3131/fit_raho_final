...
import 'package:fit_raho/src/trainer/screens/assign_work_out_routine_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AssignWorkoutRoutineScreen.routeName: (context) =>
            const AssignWorkoutRoutineScreen(),
      },
    );
  }
}
